          ...
          <ul class="list-none p-3 m-0">
            <li @click="goToHome">
              <a v-ripple class="flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple">
                ...
                <span class="font-medium text-xl">{{ $t('home')}}</span>
              </a>
            </li>
            <li @click="goToOrganizations">
              <a v-ripple class="flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple">
                <i class="pi pi-users mr-2 text-xl"></i>
                <span class="font-medium text-xl">{{ $t('organization')}}</span>
              </a>
            </li>
            <li @click="goToReports">
              <a v-ripple class="flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple">
                <i class="pi pi-chart-bar mr-2 text-xl"></i>
                <span class="font-medium text-xl">{{ $t('reports')}}</span>
              </a>
            </li>
            <li @click="goToVehicles">
              <a v-ripple class="flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple">
                <i class="pi pi-truck mr-2 text-xl"></i>
                <span class="font-medium text-xl">{{ $t('vehicles')}}</span>
              </a>
            </li>
            <li @click="goToProfile">
              <a v-ripple class="flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple">
                <i class="pi pi-cog mr-2 text-xl"></i>
                <span class="font-medium text-xl">{{ $t('settings')}}</span>
              </a>
            </li>
          </ul>
        </div>
          ...
          <ul class="list-none p-3 m-0">
            <li @click="logout">
              <a v-ripple class="flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple">
                ...
                <span class="font-medium text-xl">{{ $t('logout')}}</span>
              </a>
            </li>
          </ul>
          <div class="flex m-5">
